...
echo "6.5. Eliminant configuració smb.conf residual abans de provisionar..."
# AIXÒ ÉS CLAU: Evita que el "domain provision" falli per culpa del fitxer base d'apt-get
...
# Corregit: eliminem el paràmetre --force que feia fallar la comanda a Debian 12
